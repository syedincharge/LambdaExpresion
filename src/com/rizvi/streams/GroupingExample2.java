...
public class GroupingExample2 {
    public static void main(String[] args) {
        ...
        System.out.println("#################                   ########################                      #################                   ########################       #################                   ########################                      ######################                     ######################                      #################                   ################");        //grouping by experience where >10 years of experience is classified

        //instructor grouping them by Senior(>10) and Junior(<10) and filter them
        //on online courses
        Map<String, List<Instructor>> instructorByExperienceAndOnlineCourses = Instructors.getAll()
